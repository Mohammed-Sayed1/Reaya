...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  if (!$error_fields) {
    ...
    // Insert the data
    $query = "INSERT INTO `users` (`name`, `email`, `password`, `phone`, `address`, `role`, `gender`) VALUES ('" . $name . "', '" . $email . "', '" . $password . "', '" . $phone . "', '" . $address . "', '" . $role . "', '" . $gender . "')";
    ...
    <div class="input_container mb-5">
        ...
        <form method="post" name="formValidation" id="formValidation">
            <div class="user-details">
                ...
                <div class="input-row">
                    ...
                    <input type="password" name="password" id="password"
                        placeholder="Enter a password not less than 8 characters*" />
                    <div class="error">
            ...
            <div class="gender-details">
                <input type="radio" name="gender" value="male" id="dot-1" class="non" />
                <input type="radio" name="gender" value="female" id="dot-2" class="non" />
